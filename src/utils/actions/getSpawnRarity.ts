...
export default async function (): Promise<string> {
  ...
  if (randomRarity < 41950) {
    //COMMON RARITY RANDOMIZER
    spawnedrarity = "Common";
  }

  if (randomRarity > 41950 && randomRarity < 46950) {
    //UNCOMMON RARITY RANDOMIZER
    spawnedrarity = "Uncommon";
  }

  if (randomRarity > 46950 && randomRarity < 49450) {
    //RARE RARITY RANDOMIZER
    spawnedrarity = "Rare";
  }

  if (randomRarity > 49450 && randomRarity < 49700) {
    //LEGENDARY RARITY RANDOMIZER
    spawnedrarity = "Legendary";
  }

  if (randomRarity > 49700 && randomRarity < 49850) {
