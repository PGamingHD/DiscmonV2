...
export default async function (): Promise<string> {
    ...
    if (randomRarity < 33500) { //COMMON RARITY RANDOMIZER
        spawnedrarity = 'Common';
    }

    if (randomRarity > 33500 && randomRarity < 43500) { //UNCOMMON RARITY RANDOMIZER
        spawnedrarity = 'Uncommon';
    }

    if (randomRarity > 43500 && randomRarity < 48500) { //RARE RARITY RANDOMIZER
        spawnedrarity = 'Rare';
    }

    if (randomRarity > 48500 && randomRarity < 49500) { //LEGENDARY RARITY RANDOMIZER
        spawnedrarity = 'Legendary';
    }

    if (randomRarity > 49500 && randomRarity < 49750) { //MYTHICAL RARITY RANDOMIZER
