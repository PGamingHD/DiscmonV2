...
export default async function (interaction: CommandInteraction, options: any[], ephemeral: boolean, time = 60000, idle = 60000, collectFunc: any, customId: string, placeholder: string, content: string) {
    try {
