        ...
        return interaction.reply({
          ...
          embeds: [
            new EmbedBuilder()
              ...
              .setDescription(
                "The channel must be a text channel, and nothing else."
              ),
          ],
        });
      ...
      return interaction.reply({
        ...
        embeds: [
          new EmbedBuilder()
            ...
            .setDescription(`Spawns will now be redirect to ${channel}!`),
        ],
      });
    }
      ...
      return interaction.reply({
        ...
        embeds: [
          new EmbedBuilder()
            .setColor(Colours.GREEN)
            .setDescription(
              `Pokémons will no longer be redirected to a specific channel.`
            ),
        ],
      });
    }
