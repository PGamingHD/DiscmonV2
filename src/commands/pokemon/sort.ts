      ...
      return interaction.reply({
        ...
        embeds: [
          new EmbedBuilder()
            ...
            .setDescription(
              "The chosen sorting type is not valid, please try again"
            ),
        ],
      });
    }
      ...
      return interaction.reply({
        ...
        embeds: [
          new EmbedBuilder()
            .setColor(Colours.RED)
            .setDescription(
              "The chosen sorting type is already used, please choose another one."
            ),
        ],
      });
    ...
    return interaction.reply({
      ...
      embeds: [
        new EmbedBuilder()
          ...
          .setDescription(
            `You have successfully changed your Pokémon sorting to \`${chosen}\`!`
          ),
      ],
    });
  },
