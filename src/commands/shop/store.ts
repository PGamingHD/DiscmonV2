...
export default new Command({
  ...
  run: async ({ interaction, client }) => {
    ...
    const tokens2Row: ActionRowBuilder<AnyComponentBuilder> =
    ...
    rolesEmbed.setDescription(
      `Click the correct Button to purchase something from us, please have your DMs open to complete this!\n\n***Bronze Trainer*** • $0.99\n***Silver Trainer*** • $4.99\n***Gold Trainer*** • $9.99\n***Platinum Trainer*** • $19.99`
    );
      ...
      if (interactionCollector.customId === "bronze") {
        ...
        if (userData.trainerRank === TrainerRanks.BRONZE_TRAINER) {
          await interactionCollector.editReply({
            ...
            components: [],
            content:
              ":x: You already seem to have this rank, you may not purchase it again.",
          });
        } else {
