        ...
        return interaction.reply({
          ...
          embeds: [
            new EmbedBuilder()
              ...
              .setDescription("Invalid item ID, please use a valid ID."),
          ],
        });
          ...
          return interaction.reply({
            ...
            embeds: [
              new EmbedBuilder()
                .setColor(Colours.RED)
                .setDescription(
                  "You cannot afford to buy a redeem due to insufficient funds."
                ),
            ],
          });
        ...
        return interaction.reply({
          ...
          embeds: [
            new EmbedBuilder()
              ...
              .setDescription(
                "You have successfully bought 1 **redeem**, use it wisely!"
              ),
          ],
        });
      }
          ...
          return interaction.reply({
            ...
            embeds: [
              new EmbedBuilder()
                .setColor(Colours.RED)
                .setDescription(
                  "You cannot afford to buy an incense due to insufficient funds."
                ),
            ],
          });
        ...
        return interaction.reply({
          ...
          embeds: [
            new EmbedBuilder()
              .setColor(Colours.GREEN)
              .setDescription(
                "You have successfully bought 1 **incense**, use it wisely!"
              ),
          ],
        });
      }
          ...
          return interaction.reply({
            ...
            embeds: [
              new EmbedBuilder()
                .setColor(Colours.RED)
                .setDescription(
                  "You cannot afford to buy a buddycandy due to insufficient funds."
                ),
            ],
          });
        ...
        return interaction.reply({
          ...
          embeds: [
            new EmbedBuilder()
              .setColor(Colours.GREEN)
              .setDescription(
                "You have successfully bought 1 **BuddyCandy**, use it wisely!"
              ),
          ],
        });
      }
